      ...
      items: [
        {
          ...
          description:
            "Téléchargez gratuitement le livre au format PDF sur Fronguys.fr",
          external: true,
        },
        {
          ...
          description:
            "Impression couleur premium, format 16x24 cm sur Amazon.fr",
          external: true,
        },
        {
      ...
      items: [
        {
          ...
          href: "/links",
          description:
            "Retrouvez les liens vers les ressources citées dans le livre.",
        },
        {
          title: "Ateliers",
          href: "/workshops",
